package com.kaly.vendas.online.controller;
...
import com.kaly.vendas.online.usecase.BuscaProduto;
import com.kaly.vendas.online.usecase.CadastroProduto;
...
public class ProdutoResource {
	...
	public ResponseEntity<Produto> cadastrar(@RequestBody @Validated Produto produto) {
		return ResponseEntity.ok(cadastroProduto.cadastrar(produto));
	}
	
	@PutMapping
	@Operation(summary = "Atualiza um produto")
	public ResponseEntity<Produto> atualizar(@RequestBody @Validated Produto produto) {
