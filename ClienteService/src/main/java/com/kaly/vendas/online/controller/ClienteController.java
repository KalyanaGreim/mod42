...
import com.kaly.vendas.online.usecase.BuscaCliente;
import com.kaly.vendas.online.usecase.CadastroCliente;
...
public class ClienteController {
	...
	@PostMapping
	public ResponseEntity<Cliente> cadastar(@RequestBody @Validated Cliente cliente) {
	...
	public ResponseEntity<Cliente> atualizar(@RequestBody @Validated Cliente cliente) {
